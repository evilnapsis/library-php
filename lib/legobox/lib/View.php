...
class View {
	...
	**/	
	public static function load($view){
		// Module::$module;
		if(!isset($_GET['view'])){
			include "apps/".Lb::$name."/modules/".Module::$module."/view/".$view."/widget-default.php";
		}else{


			if(View::isValid()){
				include "apps/".Lb::$name."/modules/".Module::$module."/view/".$_GET['view']."/widget-default.php";				
			}else{
	...
	**/	
	public static function isValid(){
		$valid=false;
		if(isset($_GET["view"])){
			if(file_exists($file = "apps/".Lb::$name."/modules/".Module::$module."/view/".$_GET['view']."/widget-default.php")){
				$valid = true;
			}
		}
		return $valid;
