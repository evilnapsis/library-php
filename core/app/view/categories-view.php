...
<?php if(count($contacts)>0):?>
    ...
    <?php foreach($contacts as $con):?>
      <tr>
        ...
        <td>
          <a href="./?view=categories&opt=edit&id=<?php echo $con->id; ?>" class="btn btn-warning btn-sm"><i class="bi-pencil"></i></a>
          <a href="./?action=categories&opt=del&id=<?php echo $con->id; ?>" class="btn btn-danger btn-sm"><i class="bi-trash"></i></a>
        </td>
      </tr>
    <?php endforeach; ?>
                      </tbody>
...
$contact = CategoryData::getById($_GET["id"]);
  ?>
  <div class="">
<div class="row">
<div class="col-md-12">
